...
const newAdmin = process.env.LEXO_SAC_ADMIN;
const source = process.env.STELLAR_SOURCE_ACCOUNT;
const signingKey = process.env.STELLAR_SIGNING_KEY;

if (!sacId || !newAdmin || !source || !signingKey) {
  throw new Error(
    "Set LEXO_SAC_ID, LEXO_SAC_ADMIN, STELLAR_SOURCE_ACCOUNT and STELLAR_SIGNING_KEY.",
  );
}
